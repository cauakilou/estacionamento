...
public class UsuarioIT {
    ...
    @Test
    public void AtualizarUsuario_ComIdExistenteSenhaValida_RetornarUsuarioCriadoComStatus201() {
        testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void AtualizarUsuario_ComIdInvalido_RetornarErroMessageStatus404() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/1000")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarUsuarios_ComIdExistente_RetornarUsuarioCriadosComStatus200() {
